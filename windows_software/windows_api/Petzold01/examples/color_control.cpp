...
//---------------------------------------------------
//edit control COLOR support here
HBRUSH purple_brush = CreateSolidBrush (RGB(255, 255, 128));
...
LRESULT CALLBACK WndProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	switch (message)
	{
		...
		case WM_CTLCOLOREDIT:
			...
			//set up a purple fore ground and a yellow background
			SetTextColor ((HDC)wParam, RGB(128, 0, 128));
			SetBkColor ((HDC)wParam, RGB(255, 255, 128));
			return (LRESULT) purple_brush;
			//---------------------------------------------------
	}
